 ...
 */
public class StockBrokerDashboardData extends javax.swing.JFrame {

    /**
     * Creates new form StockBrokerDashboardData
     */
    ...
    private void initComponents() {
        ...
        jPanel1.add(graphProfit, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 120, 460, 270));
        ...
        jPanel1.add(btnHome, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 400, 120, 40));
        ...
        jLabel1.setText("Stock Broker Profits");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StockBrokerDashboardData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StockBrokerDashboardData().setVisible(true);
            }
        });
    }
