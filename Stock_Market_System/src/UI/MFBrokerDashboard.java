 ...
 * @author rishi
 */
public class MFBrokerDashboard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        labelTitle.setText("Mutual Funds Broker Dashboard");
        ...
        btnRegister.setText("Invest Shares");
        ...
        btnRegister3.setText("Check Profits");
...
//        BrokerInvestMF brokerBuyMF = new BrokerInvestMF(this.selections);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MFBrokerDashboard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MFBrokerDashboard().setVisible(true);
            }
        });
    }
