...
public class BrokerInvestMF extends javax.swing.JFrame {
    ...
    public BrokerInvestMF(String MFIndex_selected, Integer No_of_units, Integer index_unit_value, Integer Initial_wallet_balance) {
        initComponents();
        this.MFIndex_selected = MFIndex_selected;
        System.out.print("MF Index selected:"+this.MFIndex_selected);
